...
const demoItems = [
    ...
    { id: "NVI-DSK-2025-WAL", name: "Nevi Sit-Stand Desk", category: "Desking", properties: "Walnut / White", stock: 200, status: "In Stock", statusColor: "bg-zinc-100 text-muted-foreground" }
];
                                            ...
                                            <div className="p-3 rounded-xl bg-primary/5 border border-primary/10">
                                                <div className="flex gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-muted-foreground dark:text-primary/80 mt-1">8 items pending — fabric allocation in progress</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
